      ...
      <main className="portal-main">
        <header className="portal-topbar">
          ...
          <div className="portal-topbar-center">
            ...
            <div className="portal-campus-subtitle">My Report Card</div>
          </div>
        ...
        <section className="portal-hero">
          <div>
            ...
            <p className="portal-intro">
              Select the exam session and semester to view your report card.
            </p>
          </div>
        </section>
        ...
        <section className="profile-template-wrap">
          <div className="profile-template-card">
            <form className="admit-card-form" onSubmit={handleSubmit}>
              <label className="help-label" htmlFor="report-session">
                Select Session
              </label>
              <select
                id="report-session"
              ...
              <label className="help-label" htmlFor="report-semester">
                Semester
              </label>
              <select
                id="report-semester"
